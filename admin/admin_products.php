...
if(isset($_POST['add_product'])){
   ...
   $tow = $_POST['tow'];
   $tow = filter_var($tow, FILTER_SANITIZE_STRING);
   ...
   if($select_products->rowCount() > 0){
      ...
      $insert_products = $conn->prepare("INSERT INTO `products`(name, category, size, tow, details, price, image) VALUES(?,?,?,?,?,?,?)");
      $insert_products->execute([$name, $category, $size, $tow, $details, $price, $image]);
...
<section class="add-products">
   ...
   <form action="" method="POST" enctype="multipart/form-data">
      <div class="flex">
         ...
         <select name="tow" class="box" required>
            <option value="" selected disabled>select Category size</option>
